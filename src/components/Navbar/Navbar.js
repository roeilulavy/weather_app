  ...
  return (
    <div className='Navbar'>
      ...
      <nav className="Navbar__nav-container">
        {metric ?
          <img className="Navbar__temp-icon" src={Ferenheit_icon} alt="" onClick={() => handleMetric()}/>
          :
          <img className="Navbar__temp-icon" src={Celsius_icon} alt="" onClick={() => handleMetric()}/>
        }
        {checked ? 
          <img className="Navbar__theme-icon" src={Day_icon} alt="" onClick={() => handleChange()}/>
          :
          <img className="Navbar__theme-icon" src={Night_icon} alt="" onClick={() => handleChange()}/>
        }
